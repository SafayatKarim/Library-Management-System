...
namespace Library
{
    public partial class regstdadmin : Form
    {
        ...
        private void lblregister_Click(object sender, EventArgs e)
        {
            if (tbemail.Text.Contains("@") && tbemail.Text.Contains(".com"))
            {
                ...
                if (char.IsUpper(tbname.Text[0]))
                {
                    try
                    {
                        ...
                        if (this.pass.ToString() == this.retype.ToString())
                        {
                            ...
                            if (row > 0)
                            { MessageBox.Show("Student Registration Successfully", "Confirmation !!", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                ...
                {
                    MessageBox.Show("Name Must Be Start With Capital Letter");
                }
            }
            else
            {
